...
Without this, the gateway logs `Proxy headers detected from untrusted address` warnings
and the Control UI WebSocket connections may not be treated as expected.
